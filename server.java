...
class Server implements ActionListener {
    ...
    Server() {
        ...
        // Back button
        ImageIcon i1 = new ImageIcon("icons/3 (1).png");
        ...
        ImageIcon i7 = new ImageIcon("icons/video (1).png"); 
        ...
        ImageIcon i10 = new ImageIcon("icons/phone (1).png"); 
        ...
        // Profile
        ImageIcon i4 = new ImageIcon("icons/me.png");
        ...
        // Name
        JLabel name = new JLabel("Nandani");
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (dout != null) {
                dout.writeUTF(out);
                dout.flush();
                System.out.println("Server sent: " + out);
            } else {
